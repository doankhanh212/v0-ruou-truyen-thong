...
export const SECTION_KEYS = [
  ...
  "gioi-thieu.cta.label",
  "gioi-thieu.cta.title",
  "gioi-thieu.cta.body",
  "gioi-thieu.cta.primary_label",
  "gioi-thieu.cta.primary_href",
  "gioi-thieu.cta.zalo_label",
  "gioi-thieu.cta.phone_label",
  "gioi-thieu.cta.color",
  // Liên hệ — Hero
  "lien-he.hero.badge",
