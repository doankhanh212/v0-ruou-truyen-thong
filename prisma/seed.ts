...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      priceOld: 850000,
      category: "ruou-thuoc",
      description: "Minh Mạng Tửu kết hợp rượu truyền thống với dược liệu quý, hỗ trợ sức khỏe toàn diện.",
    ...
    },
    {
      ...
      priceOld: 1500000,
      category: "ruou-thuoc",
      description: "Tây dương sâm kết hợp nhụy hoa nghệ tây, hỗ trợ tăng đề kháng, ổn định huyết áp.",
    ...
    },
    {
      ...
      price: 1800000,
      category: "ruou-thuoc",
      description: "Rượu ngâm đông trùng hạ thảo quý hiếm, bồi bổ sức khỏe, tăng cường sinh lực.",
