...
export const products: Product[] = [
  {
    ...
    description:
      'Tây dương sâm còn gọi là Tây sâm, Sâm Bắc Mỹ. Theo Đông y, vị đắng hơi ngọt, tính hàn, hỗ trợ điều chỉnh rối loạn chuyển hóa mỡ, hạ đường huyết, ổn định huyết áp và tăng sức đề kháng. Somo Gold phối hợp Tây dương sâm, nhụy hoa nghệ tây cùng rượu truyền thống Cửu Long để tạo nên dòng quà biếu cao cấp, sang vị và khác biệt.',
    alcohol: '33% ACL.VOL',
    ingredients: ['Rượu truyền thống Cửu Long', 'Tây dương sâm', 'Nhụy hoa nghệ tây (Saffron)'],
    benefits: ['Bồi bổ sức khỏe', 'Quà biếu cao cấp', 'Hỗ trợ ổn định huyết áp', 'Thiết kế sang trọng'],
  ...
  },
  {
    ...
    description:
      'Minh Mạng Tửu là sự kết hợp giữa rượu trắng truyền thống Cửu Long với Minh Mạng Thang thượng hạng, quy tụ nhiều dược liệu quý Việt Nam. Dòng này thiên về duy trì sức khỏe, sinh lực nam giới và rất phù hợp để dùng hoặc biếu tặng nhờ ngoại hình gốm sang trọng.',
    alcohol: '29% ACL.VOL',
    ingredients: ['Rượu truyền thống Cửu Long', 'Minh Mạng Thang thượng hạng'],
    benefits: ['Tăng sinh lực', 'Bồi bổ nam giới', 'Dùng biếu sang trọng', 'Nhiều quy cách đóng gói'],
